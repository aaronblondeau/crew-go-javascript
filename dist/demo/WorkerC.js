...
var HttpWorker_1 = __importDefault(require("../src/HttpWorker"));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        aId = "A-" + crypto_1.default.randomBytes(8).toString('hex');
                        bId = "B-" + crypto_1.default.randomBytes(8).toString('hex');
                        cId = "C-" + crypto_1.default.randomBytes(8).toString('hex');
                        dId = "D-" + crypto_1.default.randomBytes(8).toString('hex');
