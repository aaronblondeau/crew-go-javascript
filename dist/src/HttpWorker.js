...
var HttpWorker = /** @class */ (function () {
    ...
    HttpWorker.prototype.serve = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                (_b = (_a = this.group) === null || _a === void 0 ? void 0 : _a.server) === null || _b === void 0 ? void 0 : _b.app.post('/execute/' + this.id, this.authMiddleware, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    HttpWorker.prototype.authMiddleware = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                requiredToken = process.env.CREW_WORKER_AUTH_TOKEN || '';
                if (requiredToken) {
